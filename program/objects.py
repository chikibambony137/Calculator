...
def init_objects(app):
    ...
    buttonSub = customtkinter.CTkButton(app, text="-", width=130, command=lambda: actions.print_to_textbox("-", textbox1))
    buttonSub.grid(row=6, column=0, padx=0, pady=0, sticky="ew")

    buttonMult = customtkinter.CTkButton(app, text="*", width=130, command=lambda: actions.print_to_textbox("*", textbox1))
    buttonMult.grid(row=7, column=0, padx=0, pady=0, sticky="ew")

    buttonDiv = customtkinter.CTkButton(app, text="/", width=130, command=lambda: actions.print_to_textbox("/", textbox1))
    buttonDiv.grid(row=7, column=1, padx=0, pady=0, sticky="ew")

    buttonPoint = customtkinter.CTkButton(app, text=".", width=130, command=lambda: actions.print_to_textbox(".", textbox1))
    buttonPoint.grid(row=7, column=2, padx=0, pady=0, sticky="ew")

    buttonDegree = customtkinter.CTkButton(app, text="^", width=130, command=lambda: actions.print_to_textbox("^", textbox1))
    buttonDegree.grid(row=8, column=0, padx=0, pady=0, sticky="ew")

    buttonDel = customtkinter.CTkButton(app, text="<-", width=130, command=lambda: actions.buttonDelete(textbox1))
    buttonDel.grid(row=7, column=1, padx=0, pady=0, sticky="ew")
